...
<body>
    ...
    <section id="about" class="section-px section-py px-8 md:px-16 py-24 relative overflow-hidden">
        ...
        <div class="about-grid grid md:grid-cols-2 gap-16 md:gap-20 items-center">
            ...
            <!-- Right Column - Image Grid with Professional Images -->
            <div class="fade-up relative" style="transition-delay:0.15s">
                <div class="grid grid-cols-2 grid-rows-2 gap-4 rounded-none overflow-hidden border border-green-800/30 bg-black/30 backdrop-blur-sm p-3">
                    ...
                    <div class="relative overflow-hidden aspect-square bg-gradient-to-br from-green-900/40 to-emerald-900/30 flex items-center justify-center border border-green-800/30 group hover:border-green-600/50 transition-all duration-300">
                        <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=600&h=600&fit=crop&auto=format"
                            alt="Team collaboration at Outwerk"
                            class="absolute inset-0 w-full h-full object-cover object-center transition-transform duration-500 group-hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-br from-black/40 via-black/20 to-emerald-900/30"></div>
                        <div class="relative z-10 text-center p-4">
                            <svg class="w-10 h-10 text-green-500/80 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                            </svg>
                            <span class="text-green-200 text-xs font-mono font-semibold bg-black/40 backdrop-blur-sm px-2 py-0.5 rounded-sm">Team Collaboration</span>
                        </div>
                        <div class="absolute inset-0 bg-gradient-to-br from-black/50 to-green-900/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                    </div>

                    <!-- Image 2: 24/7 Support Call Center -->
                    <div class="relative overflow-hidden aspect-square bg-gradient-to-br from-green-900/40 to-emerald-900/30 flex items-center justify-center border border-green-800/30 group hover:border-green-600/50 transition-all duration-300">
                        <img src="https://images.pexels.com/photos/3184454/pexels-photo-3184454.jpeg?auto=compress&cs=tinysrgb&w=600&h=600&fit=crop"
                            alt="Call center support agents"
                            class="absolute inset-0 w-full h-full object-cover object-center transition-transform duration-500 group-hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/50 via-black/20 to-green-900/30"></div>
                        <div class="relative z-10 text-center p-4">
                            <svg class="w-10 h-10 text-green-500/80 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                            <span class="text-green-200 text-xs font-mono font-semibold bg-black/40 backdrop-blur-sm px-2 py-0.5 rounded-sm">24/7 Support</span>
                        </div>
                    ...
                    <!-- Image 3: Agile Workflow -->
                    <div class="relative overflow-hidden aspect-square bg-gradient-to-br from-green-900/40 to-emerald-900/30 flex items-center justify-center border border-green-800/30 group hover:border-green-600/50 transition-all duration-300">
                        <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&h=600&fit=crop&auto=format"
                            alt="Agile workflow dashboard"
                            class="absolute inset-0 w-full h-full object-cover object-center transition-transform duration-500 group-hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-br from-black/40 via-emerald-900/20 to-black/30"></div>
                        <div class="relative z-10 text-center p-4">
                            <svg class="w-10 h-10 text-green-500/80 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-green-200 text-xs font-mono font-semibold bg-black/40 backdrop-blur-sm px-2 py-0.5 rounded-sm">Agile Workflow</span>
                        </div>
                        <div class="absolute inset-0 bg-gradient-to-br from-black/50 to-green-900/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </div>

                    <!-- Image 4: Branding with Office/HQ Context -->
                    <div class="relative overflow-hidden flex flex-col justify-center items-center bg-gradient-to-br from-green-900/50 to-emerald-900/40 border border-green-800/30 group hover:border-green-600/50 transition-all duration-300">
                        <img src="https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?w=600&h=600&fit=crop&auto=format"
                            alt="Outwerk modern office Karachi"
                            class="absolute inset-0 w-full h-full object-cover object-center transition-transform duration-500 group-hover:scale-105">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-emerald-900/50"></div>
                        <div class="relative z-10 text-center p-4">
                            <div class="text-2xl md:text-3xl font-bold text-white/90 mb-2 tracking-tight drop-shadow-lg" style="font-family:'Space Grotesk';">OUTWERK</div>
                            <div class="mono text-[10px] tracking-widest text-green-300 drop-shadow">KARACHI, PAKISTAN</div>
                            <div class="w-8 h-px bg-green-500/80 mx-auto my-2"></div>
                            <div class="mono text-[9px] tracking-widest text-green-300/90">EST. 2019</div>
                        </div>
                        <div class="absolute inset-0 bg-gradient-to-br from-black/30 to-green-900/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                    </div>
                </div>

                <!-- Floating Cards -->
                <div class="floating-card absolute -bottom-6 -left-6 p-4 rounded-none blur-card border border-green-800/30 bg-black/60 backdrop-blur-md w-36 hidden md:flex">
                ...
                <div class="floating-card absolute -top-6 -right-6 p-4 rounded-none blur-card border border-green-800/30 bg-black/60 backdrop-blur-md w-40 hidden md:block">
